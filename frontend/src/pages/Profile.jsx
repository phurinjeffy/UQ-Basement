...
function Profile() {
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-950 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-950 flex flex-col items-center justify-center px-4 py-10">
      <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-lg rounded-3xl shadow-xl border border-white/20 dark:border-slate-700/50 p-10 max-w-lg w-full flex flex-col items-center animate-fadeInUp">
        {/* Profile Avatar */}
        ...
        <div className="text-center mb-8">
          ...
          <div className="bg-gray-50 dark:bg-slate-700/50 rounded-lg p-3 inline-block">
            <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Email Address</div>
            <div className="font-mono text-gray-800 dark:text-gray-200">{user.email}</div>
          </div>
        </div>
