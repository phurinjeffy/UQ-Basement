...
from routers import users, courses, ai, questions, enrollments, quiz, answers, quiz_stats
...
app.include_router(quiz_stats.router, prefix="/api/v1/quiz", tags=["Quiz Stats"])
